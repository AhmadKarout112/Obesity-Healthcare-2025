...
import numpy as np
from obesity_predictor import render_prediction_tab
...
# Add custom CSS for a more compact dashboard
st.markdown("""
<style>
    .block-container {
        padding-top: 1rem;
...
tab1, tab2 = st.tabs(["📊 Analytics Dashboard", "🔮 Obesity Prediction"])

with tab1:
    # Title and description (shorter)
    st.title("🏥 Obesity Analytics Dashboard 2025", anchor=False)
